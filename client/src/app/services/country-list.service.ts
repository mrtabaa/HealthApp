...
export class CountryListService {
  ...
  countries = [
    ...
    { code: '1268', acr: 'ag', name: 'Antigua &amp; Barbuda (+1268)', shortName: 'amp; Barbuda', flag: '' },
    ...
    { code: '239', acr: 'st', name: 'Sao Tome &amp; Principe (+239)', shortName: 'amp; Principe', flag: '' },
    ...
    { code: '1868', acr: 'tt', name: 'Trinidad &amp; Tobago (+1868)', shortName: 'amp; Tobago', flag: '' },
    ...
    { code: '1649', acr: 'tc', name: 'Turks &amp; Caicos Islands (+1649)', shortName: 'Caicos Islands', flag: '' },
    ...
    { code: '681', acr: 'wf', name: 'Wallis &amp; Futuna (+681)', shortName: 'amp; Futuna', flag: '' },
